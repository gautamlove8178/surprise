...
export default function FinalScreen() {
  ...
  const proposalMessage = `Jab se tum meri zindagi me aaye, sab kuch badal gaya 🌸✨
Tumne mere ordinary dinon me rang bhar diye 🌈, meri khamoshi me warmth 🔥, aur woh khushi jo mujhe pata bhi nahi thi ki mujhe chahiye 😍

Har sunrise ab aur bhi bright lagti hai tumhari wajah se 🌅💖
Har dream ab possible lagta hai kyunki tum mujhe inspire karti ho 💫🌹
Har challenge easy lagta hai kyunki main tumhe apne side me imagine karta hoon 🥰💪

Tum sirf meri friend nahi ho, tum meri zindagi ka sabse special hissa ho 💖🌟
Tum mujhe smile karwati ho 😄, mera dil fast dhadakta hai 💓, aur tum mujhe better version banne ke liye motivate karti ho 🌈🔥

Mujhe nahi pata future me kya hoga 🤷‍♂️
Lekin ek cheez pakki hai—
Main woh future sirf tumhare saath chahta hoon 💞🌹💖`
